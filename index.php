        ...
        <div class="row">
            ...
            <div class="col s12 m7" class="mainAll">
                ...
                if(mysqli_num_rows($result) > 0){
                    ...
                    <div class=" row col m3 imgContainer">
                        <img class="img" src="https://images.pexels.com/photos/2090649/pexels-photo-2090649.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
