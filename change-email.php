...
if(isset($_POST['save'])){
    ...
    if(empty($msg)){
        ...
        $sql1 = "UPDATE users SET email = '$uemail' WHERE email = '$email' ";
        ...
        if(mysqli_query($link, $sql1)){
          ...
          echo "<script>
           window.location.href='change-email.php?success';
           </script>";  
      ...
      <div class="row">
        ...
        <div class="col s12 m7">
            <?php if($msg != "") echo "<div style='padding:20px;background-color:#dce8f7;color:black'> $msg</div class='btn btn-success'>" ."</br></br>";  ?>
                                <?php if(isset($_GET['success']) && $msg == "") echo "<div style='padding:20px;background-color:#dce8f7;color:black'> Email updated successfully </div class='btn btn-success'>" ."</br>";  ?>
          <div class="row">
